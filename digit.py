...
if sys.argv[1] == "file":
    ...
    infile = os.path.join(directory, 'assets/img{0}.jpg'.format(sys.argv[2]))
    outfile = os.path.join(directory, 'assets/resize.jpg')
...
if sys.argv[1] == "loop":
    ...
    for i in range(0, 10):
        directory = os.path.dirname(os.path.abspath(__file__))
        infile = os.path.join(directory, 'assets/img{0}.jpg'.format(i))
        outfile = os.path.join(directory, 'assets/resize.jpg')
